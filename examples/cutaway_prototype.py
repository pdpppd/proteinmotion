"""Prototype: tunnels that show how deep a selection lies in GroEL–GroES (PDB 1AON).
...
Atoms are hidden or ghosted for visibility only; none move.
    ...
    proteinmotion render examples/cutaway_prototype.py CutawayPrototype --fps 60 -o tunnel.mp4
"""
...
class CutawayPrototype(ProteinScene):
