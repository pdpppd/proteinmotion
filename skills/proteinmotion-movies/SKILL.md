...
description: Create and render programmatic protein movies with ProteinMotion from PDB/mmCIF structures or trajectories, including molecular representations, eased motion, region annotations, and protein morphs. Use for making or revising molecular animation scripts and their rendered videos.
---

# ProteinMotion Movies

Deliver an editable Python scene and a rendered movie using ProteinMotion. Preserve the user's protein, selected regions, scientific message, duration, and output format. This is a standalone renderer with Manim-inspired syntax, not a Manim Mobject plugin.
