...
[Skill source](https://github.com/pdpppd/proteinmotion/tree/main/skills/proteinmotion-movies) · [Download ZIP](https://github.com/pdpppd/proteinmotion/releases/download/v0.8.0/proteinmotion-movies-v0.8.0.zip)
