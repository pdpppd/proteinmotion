...
[Skill source](https://github.com/pdpppd/proteinmotion/tree/main/skills/proteinmotion-movies) · [Download ZIP](https://github.com/pdpppd/proteinmotion/releases/download/v0.7.0/proteinmotion-movies-v0.7.0.zip)
